...
class IndexController extends Controller
{
    ...
    public function entity_link($id)
    {
        ...
        return view('frontend.entity', compact('entity','entity_types', 'facets', 'sub_facets', 'sub_entities','sub_resources', 'locations'));
        ...
        public function resource_link($id)
    {
        ...
        return view('frontend.resource', compact('resource','entity_types', 'sub_facets', 'sub_entities','sub_resources'));
    }
