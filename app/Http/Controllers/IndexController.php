...
class IndexController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('entity_types', 'facet_types', 'entities', 'facets'));
    }
    ...
    public function entity_link($id)
    {
        ...
        return view('frontend.entity', compact('entity','entity_types', 'facet_types', 'facets', 'sub_facets', 'sub_entities','sub_resources', 'locations'));
    ...
    public function facet_link($id)
    {
        ...
        return view('frontend.facet', compact('facet','entity_types', 'facet_types', 'sub_facets', 'sub_entities','sub_resources'));
    }
        ...
        public function resource_link($id)
    {
        ...
        return view('frontend.resource', compact('resource','entity_types', 'facet_types', 'sub_facets', 'sub_entities','sub_resources'));
    }
